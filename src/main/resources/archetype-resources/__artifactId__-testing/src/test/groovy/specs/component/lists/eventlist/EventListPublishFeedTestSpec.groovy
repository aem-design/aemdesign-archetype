...
class EventListPublishFeedTestSpec extends ComponentSpec {
    ...
    def "Event List: Default with ICS Feed Enabled"() {
        ...
        def downloadSHA1 = downloadContent("/content/${contentFolderName}-showcase/au/en/component/lists/event-list/jcr:content/article/par/contentblock5/par/eventlist.test.ics")
