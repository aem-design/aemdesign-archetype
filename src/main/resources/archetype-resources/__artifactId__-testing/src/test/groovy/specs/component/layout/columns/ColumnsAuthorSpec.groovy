...
class ColumnsAuthorSpec extends ComponentSpec {
    ...
    def "Authoring of Component"() {
        ...
        //check for overlay
        waitFor {  ${symbol_dollar}(".cq-Overlay[data-path='"+compileComponentPath()+"']")  }
        //check for component placeholder
        waitFor { withFrame(TouchUIEditor.PAGE_FRAME_CONTENT) { ${symbol_dollar}("cq[data-path='"+compileComponentPath()+"']")  } }
