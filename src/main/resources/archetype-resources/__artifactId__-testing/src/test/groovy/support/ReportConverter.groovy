...
class ReportConverter {
    static convertJsonReport() {
        ...
        def reportsDir = "${symbol_dollar}{gebEnvReportsDir}/"
        def thisPath = new File('.').canonicalPath.replaceAll('${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}', '/')
        def gebReports = new File(reportsDir, "gebReportInfo.json").text.replaceAll('${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}', '/')
