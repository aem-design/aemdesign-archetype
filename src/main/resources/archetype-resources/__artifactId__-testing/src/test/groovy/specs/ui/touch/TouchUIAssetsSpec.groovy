...
class TouchUIAssetsSpec extends AuthorSpec {
    ...
    static final String PATH_DAM = '/content/dam/${contentFolderName}'
    ...
    def "Should see if there is a We.Retail Assets folder"() {
        ...
        assert page.find(".foundation-collection-item[data-foundation-collection-item-id='${symbol_dollar}{PATH_DAM}']") != null
