...
class NewsDetailsScreenshotSpec extends ComponentSpec {
    ...
    @Unroll("Appearance of News Details Component with Excluded Components in ${symbol_pound}viewport.label")
    ...
    @Unroll("Appearance of News Details Component with Included Components in ${symbol_pound}viewport.label")
    ...
    @Unroll("Appearance of News Details Component with Background and Formatted Date in ${symbol_pound}viewport.label")
