    ...
    "local-chrome" {
        driver = {
            ...
            if (!driverFile.canExecute()) {
                ...
                Runtime.getRuntime().exec("chmod +x ${symbol_dollar}driverPath")
                if (!driverFile.canExecute()) {
                    printDebug("PLEASE FIX DRIVER PERMISSIONS MANUALLY", [${symbol_dollar}driverPath])
                    System.exit(0)
                }
            }
...
//            printDebug("SETTINGS URL1", System.getProperty("webdriver.gecko.driver"))
            ...
            options.addArguments(Arrays.asList(
                    ...
                    "--user-data-dir=${symbol_dollar}{GLOBAL_BUILD_DIR}/chrome-user-data",
...
//            driver.setLogLevel(Level.OFF)
    ...
    "remote-browserstack" {
        ...
        String GEB_BROWSERSTACK_URL = "${symbol_dollar}GEB_BROWSERSTACK_SCHEMA://${symbol_dollar}GEB_BROWSERSTACK_USERNAME:${symbol_dollar}GEB_BROWSERSTACK_AUTHKEY@${symbol_dollar}GEB_BROWSERSTACK_HOST"
        ...
        printDebug("DRIVER URL", "${symbol_dollar}GEB_BROWSERSTACK_URL")
