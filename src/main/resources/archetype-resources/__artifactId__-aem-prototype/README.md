...
#### V1
- Build directly into AEM: `yarn build:v1`
- Watch for changes and sync into AEM: `yarn dev:v1`

#### V2
- Build directly into AEM: `yarn build:v2`
- Watch for changes and sync into AEM: `yarn dev:v2`
